...
### [[Linux/files-and-permisssions|Linux permissions]] - dodavanje permisija iliti docker komande bez sudo prefixa
...
### 13. [[1.Security|docker-security]] bezbedno postavljanje imag-a online

### 14. [[optimizacija fajla]] optimizacija Dockerfile-a

### 15. [[WSL Setup Docker]] WSL instalacija Docker-a i Portainer-a
