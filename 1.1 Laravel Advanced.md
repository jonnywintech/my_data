...
### 6. [[Laravel Advanced/docker-run-composer-install|Docker composer install]] instalacija Laravel-a preko docker run

### 7. [[faker-serbian-locale]] srpski locale za Faker

### 8. [[versioning of files (cached files)]] verzionisanje keširanih fajlova

### 9. [[Korisne komponente]] korisne Laravel komponente
