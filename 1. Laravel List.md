...
22 [[Cronjob Commands]] Komande koje se izvrsavaju posle X vremena

23. [[starting laravel/components/Delete Button|Delete Button]] dugme za brisanje
24. [[starting laravel/components/Cookes Banner models|Cookies Banner]] cookie banner model
25. [[starting laravel/components/Popup Error notification -- Tailwind|Popup Error notification]] Tailwind popup za greške
26. [[starting laravel/components/Kloniranje div reda sa old variablom|Kloniranje div reda]] kloniranje reda sa old varijablom
27. [[starting laravel/view_slug|view_slug]] dodavanje slug-a na rutu
28. [[new file or cloning project]] alternativni način kreiranja projekta
